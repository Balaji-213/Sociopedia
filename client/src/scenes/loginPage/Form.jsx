...
const Form = () => {
  ...
  const handleDrop = async (acceptedFiles, setFieldValue) => {
    ...
    setFieldValue("pictureName", file);

    const base64String = await convertFileToBase64(file);
    // await uploadImage(base64String, setFieldValue);  
  ...
  const register = async (values, onSubmitProps) => {
    ...
    try {
      ...
      // Display an alert with the caught error message
                    ...
                    {({ getRootProps, getInputProps }) => (
                      ...
                      >
                        ...
                        {!values.picture ? (
                          ...
                          <FlexBetween>
                            <Typography>{values.pictureName.name}</Typography>
                            <EditOutlinedIcon />
                          </FlexBetween>
                        )}
                      </Box>
          ...
          <Box>
            ...
            >
              <Box display="flex" alignItems="center">
                ...
                <Box ml={1}>Login with Google</Box> {/* Adding margin-left to the text */}
              </Box>
            </Button>
          </Box>
        </form>
